...
par(mfrow=c(2,2))
with(dt,plot(Date_Time,Global_active_power,type="l",ylab="Global Active Power",xlab=""))
with(dt,plot(Date_Time,Voltage,type="l",ylab="Voltage",xlab=""))
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"), pch="", lty=1 ,bty="n")
with(dt,plot(Date_Time,Global_reactive_power,type="l",ylab="Global Reactive Power",xlab=""))
